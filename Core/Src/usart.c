...
uint8_t USART_RX_BUF[USART_REC_LEN];  // ������USART_REC_LEN���ֽ�
uint16_t USART_RX_STA = 0;            // ����״̬��־
uint8_t aRxBuffer[RXBUFFERSIZE];      // HAL����ջ���?

extern UART_HandleTypeDef huart1;     // ȷ���ܷ��ʵ� huart1
...
{	
	...
	HAL_UART_Receive_IT(&huart1, (u8 *)aRxBuffer, RXBUFFERSIZE);//�ú����Ὺ�������жϣ���־λUART_IT_RXNE���������ý��ջ����Լ����ջ���������������
