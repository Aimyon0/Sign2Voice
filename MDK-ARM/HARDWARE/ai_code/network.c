...
/*****************************************************************************/
#define _STAI_NETWORK_MODEL_SIGNATURE     "0x5f3c978ced3b7aff0142c989c3b31656"
#define _STAI_NETWORK_DATETIME            "2026-07-15T09:54:54+0000"
...
static const stai_network_info g_network_info = {
  ...
  .activations = (stai_tensor[STAI_NETWORK_ACTIVATIONS_NUM]) {
    STAI_INIT_TENSOR(
      ...
      STAI_DECLARE_ARRAY(int32_t, 1, 79024),
      STAI_EMPTY_ARRAY(),
      STAI_EMPTY_ARRAY()),
    },
...
void forward_lite_dense_integer_SSSA_ch_gemm_11(_stai_network_context* net_ctx)
{
  pool_6_output_array.data = AI_PTR(net_ctx->_activations[0] + 0);
  pool_6_output_array.data_start = AI_PTR(net_ctx->_activations[0] + 0);
  ...
  gemm_11_scratch0_array.data = AI_PTR(net_ctx->_activations[0] + 2048);
  gemm_11_scratch0_array.data_start = AI_PTR(net_ctx->_activations[0] + 2048);
  gemm_11_output_array.data = AI_PTR(net_ctx->_activations[0] + 6784);
  gemm_11_output_array.data_start = AI_PTR(net_ctx->_activations[0] + 6784);
  _STAI_NETWORK_EVENT_NODE_START_CB(11, 1, { pool_6_output0.data->data});
  forward_dense_integer_SSSA_ch(&gemm_11_layer);
  _STAI_NETWORK_EVENT_NODE_STOP_CB(11, 1, { gemm_11_output.data->data});
}
void forward_lite_dense_integer_SSSA_ch_gemm_12(_stai_network_context* net_ctx)
{
  ...
  gemm_12_output_array.data = AI_PTR(net_ctx->_activations[0] + 180);
  gemm_12_output_array.data_start = AI_PTR(net_ctx->_activations[0] + 180);
  _STAI_NETWORK_EVENT_NODE_START_CB(12, 1, { gemm_11_output.data->data});
  ...
  const stai_run_mode mode)
{
  ...
  /* LITE_KERNEL_SECTION BEGIN conversion_0 */
  {
    ...
    ai_i8* conversion_0_t_out_0_ptr_s8 = (ai_i8*)(net_ctx->_activations[0] + 66732);
  ...
  {
      const ai_i8* conv2d_1_t_in_0_ptr_const_s8 = (ai_i8*)(net_ctx->_activations[0] + 66732);
    ...
    ai_i16* conv2d_1_t_scratch_0_ptr_s16 = (ai_i16*)(net_ctx->_activations[0] + 65536);
  ...
  {
      const ai_i8* pool_2_t_in_0_ptr_const_s8 = (ai_i8*)(net_ctx->_activations[0] + 0);
  ...
  /* LITE_KERNEL_SECTION BEGIN conv2d_3_pad_before */
  {
    ...
    ai_ptr conv2d_3_pad_before_t_out_0_ptr_ptr = (ai_ptr)(net_ctx->_activations[0] + 16384);
  ...
  {
      const ai_i8* conv2d_3_t_in_0_ptr_const_s8 = (ai_i8*)(net_ctx->_activations[0] + 16384);
    ...
    ai_i8* conv2d_3_t_out_0_ptr_s8 = (ai_i8*)(net_ctx->_activations[0] + 34880);
  ...
  {
      const ai_i8* pool_4_t_in_0_ptr_const_s8 = (ai_i8*)(net_ctx->_activations[0] + 34880);
  ...
  {
      const ai_ptr conv2d_5_pad_before_t_in_0_ptr_const_ptr = (ai_ptr)(net_ctx->_activations[0] + 0);
    ai_ptr conv2d_5_pad_before_t_out_0_ptr_ptr = (ai_ptr)(net_ctx->_activations[0] + 6144);
  ...
  {
      const ai_i8* conv2d_5_t_in_0_ptr_const_s8 = (ai_i8*)(net_ctx->_activations[0] + 6144);
    ...
    ai_i8* conv2d_5_t_out_0_ptr_s8 = (ai_i8*)(net_ctx->_activations[0] + 20352);
    ai_i16* conv2d_5_t_scratch_0_ptr_s16 = (ai_i16*)(net_ctx->_activations[0] + 13920);
  ...
  {
      const ai_i8* pool_6_t_in_0_ptr_const_s8 = (ai_i8*)(net_ctx->_activations[0] + 20352);
    ai_i8* pool_6_t_out_0_ptr_s8 = (ai_i8*)(net_ctx->_activations[0] + 0);
  
  _STAI_NETWORK_EVENT_NODE_START_CB(6, 1, {(stai_ptr) pool_6_t_in_0_ptr_const_s8});
  ...
  _STAI_NETWORK_EVENT_NODE_STOP_CB(6, 1, {(stai_ptr) pool_6_t_out_0_ptr_s8});
  }
  ...
  {
      ai_i8* nl_13_t_out_0_ptr_s8 = (ai_i8*)(net_ctx->_activations[0] + 0);
    const ai_i8* nl_13_t_in_0_ptr_const_s8 = (ai_i8*)(net_ctx->_activations[0] + 180);
    ai_i32* nl_13_t_scratch_0_ptr_s32 = (ai_i32*)(net_ctx->_activations[0] + 188);
  
  _STAI_NETWORK_EVENT_NODE_START_CB(13, 1, {(stai_ptr) nl_13_t_in_0_ptr_const_s8});
  ...
  _STAI_NETWORK_EVENT_NODE_STOP_CB(13, 1, {(stai_ptr) nl_13_t_out_0_ptr_s8});
  }
  /* LITE_KERNEL_SECTION END nl_13 */
  /* LITE_KERNEL_SECTION BEGIN conversion_14 */
  {
      const ai_i8* conversion_14_t_in_0_ptr_const_s8 = (ai_i8*)(net_ctx->_activations[0] + 0);
    ai_float* conversion_14_t_out_0_ptr_f32 = (ai_float*)(net_ctx->_outputs[0] + 0);
  
  _STAI_NETWORK_EVENT_NODE_START_CB(14, 1, {(stai_ptr) conversion_14_t_in_0_ptr_const_s8});
  ...
  _STAI_NETWORK_EVENT_NODE_STOP_CB(14, 1, {(stai_ptr) conversion_14_t_out_0_ptr_f32});
  }
...
const uintptr_t _activations_alignment[] = STAI_NETWORK_ACTIVATIONS_ALIGNMENTS;
  ...
  net_ctx->_inputs[0] = activations[0] + 17580;
