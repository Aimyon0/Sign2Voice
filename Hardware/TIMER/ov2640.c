...
{
	if(sw==0)	HAL_GPIO_WritePin(GPIOA,GPIO_PIN_5,GPIO_PIN_RESET);	//PA5--CH1 置0
	else HAL_GPIO_WritePin(GPIOA,GPIO_PIN_5,GPIO_PIN_SET);	      //PA5--CH1 置1
