/**
  ...
  ******************************************************************************
  */
#ifndef AI_GESTURE_FINETUNED_H
#define AI_GESTURE_FINETUNED_H

#include "gesture_finetuned_config.h"
#include "ai_platform.h"

/******************************************************************************/
#define AI_GESTURE_FINETUNED_MODEL_NAME          "gesture_finetuned"
#define AI_GESTURE_FINETUNED_ORIGIN_MODEL_NAME   "gesture_cnn_combined_fp32"

/******************************************************************************/
#define AI_GESTURE_FINETUNED_ACTIVATIONS_ALIGNMENT   (4)
#define AI_GESTURE_FINETUNED_INPUTS_IN_ACTIVATIONS   (4)
#define AI_GESTURE_FINETUNED_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_GESTURE_FINETUNED_IN_NUM        (1)

AI_DEPRECATED
#define AI_GESTURE_FINETUNED_IN \
  ai_gesture_finetuned_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_GESTURE_FINETUNED_IN_SIZE { \
  AI_GESTURE_FINETUNED_IN_1_SIZE, \
}
#define AI_GESTURE_FINETUNED_IN_SIZE_BYTES { \
  AI_GESTURE_FINETUNED_IN_1_SIZE_BYTES, \
}
#define AI_GESTURE_FINETUNED_IN_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_GESTURE_FINETUNED_IN_1_HEIGHT      (64)
#define AI_GESTURE_FINETUNED_IN_1_WIDTH       (64)
#define AI_GESTURE_FINETUNED_IN_1_CHANNEL     (3)
#define AI_GESTURE_FINETUNED_IN_1_SIZE        (12288)
#define AI_GESTURE_FINETUNED_IN_1_SIZE_BYTES  (49152)

/******************************************************************************/
#define AI_GESTURE_FINETUNED_OUT_NUM       (1)

AI_DEPRECATED
#define AI_GESTURE_FINETUNED_OUT \
  ai_gesture_finetuned_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_GESTURE_FINETUNED_OUT_SIZE { \
  AI_GESTURE_FINETUNED_OUT_1_SIZE, \
}
#define AI_GESTURE_FINETUNED_OUT_SIZE_BYTES { \
  AI_GESTURE_FINETUNED_OUT_1_SIZE_BYTES, \
}
#define AI_GESTURE_FINETUNED_OUT_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_GESTURE_FINETUNED_OUT_1_CHANNEL     (5)
#define AI_GESTURE_FINETUNED_OUT_1_SIZE        (5)
#define AI_GESTURE_FINETUNED_OUT_1_SIZE_BYTES  (20)

/******************************************************************************/
#define AI_GESTURE_FINETUNED_N_NODES (7)


AI_API_DECLARE_BEGIN

/*!
 * @defgroup gesture_finetuned
 ...
 * @ref ai_gesture_finetuned_create. Both the activations memory buffer 
 ...
 * using @ref ai_gesture_finetuned_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_buffer* ai_gesture_finetuned_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_gesture_finetuned_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_GESTURE_FINETUNED_*
 * defines into file @ref gesture_finetuned.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_gesture_finetuned_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /* AI_GESTURE_FINETUNED_H */
