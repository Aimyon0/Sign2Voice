...
#define AI_GESTURE_DATA_ACTIVATIONS_SIZES \
  { 79024, }
#define AI_GESTURE_DATA_ACTIVATIONS_SIZE     (79024)
#define AI_GESTURE_DATA_ACTIVATIONS_COUNT    (1)
#define AI_GESTURE_DATA_ACTIVATION_1_SIZE    (79024)



#define AI_GESTURE_DATA_WEIGHTS_SIZES \
  { 142756, }
#define AI_GESTURE_DATA_WEIGHTS_SIZE         (142756)
#define AI_GESTURE_DATA_WEIGHTS_COUNT        (1)
#define AI_GESTURE_DATA_WEIGHT_1_SIZE        (142756)
