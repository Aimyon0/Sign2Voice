...
/******************************************************************************/
#define AI_GESTURE_MODEL_NAME          "gesture"
#define AI_GESTURE_ORIGIN_MODEL_NAME   "gesture_cnn_combined_int8"

/******************************************************************************/
#define AI_GESTURE_ACTIVATIONS_ALIGNMENT   (4)
#define AI_GESTURE_INPUTS_IN_ACTIVATIONS   (4)
#define AI_GESTURE_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_GESTURE_IN_NUM        (1)

AI_DEPRECATED
#define AI_GESTURE_IN \
  ai_gesture_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_GESTURE_IN_SIZE { \
  AI_GESTURE_IN_1_SIZE, \
}
#define AI_GESTURE_IN_SIZE_BYTES { \
  AI_GESTURE_IN_1_SIZE_BYTES, \
}
#define AI_GESTURE_IN_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_GESTURE_IN_1_HEIGHT      (64)
#define AI_GESTURE_IN_1_WIDTH       (64)
#define AI_GESTURE_IN_1_CHANNEL     (3)
#define AI_GESTURE_IN_1_SIZE        (12288)
#define AI_GESTURE_IN_1_SIZE_BYTES  (49152)

/******************************************************************************/
#define AI_GESTURE_OUT_NUM       (1)

AI_DEPRECATED
#define AI_GESTURE_OUT \
  ai_gesture_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_GESTURE_OUT_SIZE { \
  AI_GESTURE_OUT_1_SIZE, \
}
#define AI_GESTURE_OUT_SIZE_BYTES { \
  AI_GESTURE_OUT_1_SIZE_BYTES, \
}
#define AI_GESTURE_OUT_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_GESTURE_OUT_1_CHANNEL     (5)
#define AI_GESTURE_OUT_1_SIZE        (5)
#define AI_GESTURE_OUT_1_SIZE_BYTES  (20)

/******************************************************************************/
#define AI_GESTURE_N_NODES (13)
 ...
 * @ref ai_gesture_create. Both the activations memory buffer 
 ...
 * using @ref ai_gesture_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_buffer* ai_gesture_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_gesture_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_GESTURE_*
 * defines into file @ref gesture.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
