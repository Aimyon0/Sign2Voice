/**
  ...
  ******************************************************************************
  */
#ifndef STAI_GESTURE_H
#define STAI_GESTURE_H
...
#define STAI_GESTURE_ORIGIN_MODEL_NAME         "gesture_cnn_combined_int8"
#define STAI_GESTURE_ORIGIN_MODEL_SIGNATURE    "0x5f3c978ced3b7aff0142c989c3b31656"

/*  Generated model name and signature  */
#define STAI_GESTURE_MODEL_NAME                "gesture"
#define STAI_GESTURE_MODEL_SIGNATURE           (0xa53f72815267811a)


/*****************************************************************************/
/*  Macros to declare network context size and required alignment  */
#define STAI_GESTURE_CONTEXT_ALIGNMENT   8
#define STAI_GESTURE_CONTEXT_SIZE        (sizeof(_stai_gesture_context))

/*  Macro to declare network flags  */
#define STAI_GESTURE_FLAGS               (STAI_FLAG_INPUTS|STAI_FLAG_OUTPUTS|STAI_FLAG_WEIGHTS)

/*  Macro to declare number of network C nodes generated  */
#define STAI_GESTURE_NODES_NUM           (13)

/*  Macro to declare number macc for generated network model  */
#define STAI_GESTURE_MACC_NUM            (7332386)

/*  Macros to declare input buffers characteristics  */
#define STAI_GESTURE_IN_NUM              (1)
#define STAI_GESTURE_IN_SIZE_BYTES       (49156)

#define STAI_GESTURE_IN_ALIGNMENTS \
  { 4}
#define STAI_GESTURE_IN_NAMES \
  { NULL}
#define STAI_GESTURE_IN_FORMATS \
  { STAI_FORMAT_FLOAT32}
#define STAI_GESTURE_IN_SIZES \
  {12288}
#define STAI_GESTURE_IN_SIZES_BYTES \
  {49152}

#define STAI_GESTURE_IN_1_ALIGNMENT   4
#define STAI_GESTURE_IN_1_NAME        (NULL)
#define STAI_GESTURE_IN_1_FLAGS       (STAI_FLAG_INPUTS|STAI_FLAG_PREALLOCATED|STAI_FLAG_CHANNEL_LAST|STAI_FLAG_HAS_BATCH)
#define STAI_GESTURE_IN_1_FORMAT      (STAI_FORMAT_FLOAT32)
#define STAI_GESTURE_IN_1_SHAPE       {1,64,64,3}
#define STAI_GESTURE_IN_1_BATCH       (1)
#define STAI_GESTURE_IN_1_HEIGHT      (64)
#define STAI_GESTURE_IN_1_WIDTH       (64)
#define STAI_GESTURE_IN_1_CHANNEL     (3)
#define STAI_GESTURE_IN_1_RANK        (3)
#define STAI_GESTURE_IN_1_SIZE        (12288)
#define STAI_GESTURE_IN_1_SIZE_BYTES  (49152)

/*****************************************************************************/
/*  Macros to declare output buffers characteristics  */
#define STAI_GESTURE_OUT_NUM             (1)
#define STAI_GESTURE_OUT_SIZE_BYTES      (24)
#define STAI_GESTURE_OUT_ALIGNMENTS \
  { 4}
#define STAI_GESTURE_OUT_NAMES \
  { NULL}
#define STAI_GESTURE_OUT_FORMATS \
  { STAI_FORMAT_FLOAT32}
#define STAI_GESTURE_OUT_SIZES \
  { 5}
#define STAI_GESTURE_OUT_SIZES_BYTES \
  {20}

#define STAI_GESTURE_OUT_1_ALIGNMENT   4
#define STAI_GESTURE_OUT_1_NAME        (NULL)
#define STAI_GESTURE_OUT_1_FLAGS       (STAI_FLAG_OUTPUTS|STAI_FLAG_PREALLOCATED|STAI_FLAG_CHANNEL_LAST|STAI_FLAG_HAS_BATCH)
#define STAI_GESTURE_OUT_1_FORMAT      (STAI_FORMAT_FLOAT32)
#define STAI_GESTURE_OUT_1_SHAPE       {1,5}
#define STAI_GESTURE_OUT_1_BATCH       (1)
#define STAI_GESTURE_OUT_1_CHANNEL     (5)
#define STAI_GESTURE_OUT_1_RANK        (1)
#define STAI_GESTURE_OUT_1_SIZE        ((5))
#define STAI_GESTURE_OUT_1_SIZE_BYTES  (20)

/*****************************************************************************/
/*  Macros to declare activations buffers characteristics  */
#define STAI_GESTURE_ACTIVATIONS_SIZE              (85056)
#define STAI_GESTURE_ACTIVATIONS_SIZE_BYTES        (85056)
#define STAI_GESTURE_ACTIVATIONS_ALIGNMENTS \
  { 4}
#define STAI_GESTURE_ACTIVATIONS_SIZES \
  { 85056}
#define STAI_GESTURE_ACTIVATIONS_NUM               (1)

#define STAI_GESTURE_ACTIVATION_1_FLAGS      (STAI_FLAG_ACTIVATIONS)
#define STAI_GESTURE_ACTIVATION_1_SIZE       (85056)
#define STAI_GESTURE_ACTIVATION_1_SIZE_BYTES (85056)
#define STAI_GESTURE_ACTIVATION_1_ALIGNMENT  4
/*  Macros to declare weights buffers characteristics  */

#define STAI_GESTURE_WEIGHTS_NUM                  (1)
#define STAI_GESTURE_WEIGHTS_SIZE                  (142756)
#define STAI_GESTURE_WEIGHTS_SIZE_BYTES            (142756)
#define STAI_GESTURE_WEIGHTS_ALIGNMENTS \
  { 4}
#define STAI_GESTURE_WEIGHTS_SIZES \
  { 142756}
#define STAI_GESTURE_WEIGHTS_NUM        (1)
#define STAI_GESTURE_WEIGHT_1_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_GESTURE_WEIGHT_1_SIZE        (142756)
#define STAI_GESTURE_WEIGHT_1_SIZE_BYTES  (142756)


/*****************************************************************************/
/*  Macros to declare states buffers characteristics  */
#define STAI_GESTURE_STATES_SIZE              (0)
#define STAI_GESTURE_STATES_SIZE_BYTES        (0)
#define STAI_GESTURE_STATES_ALIGNMENTS        {}
#define STAI_GESTURE_STATES_SIZES             { 0, }
#define STAI_GESTURE_STATES_NUM               (0)

#define STAI_GESTURE_STATE_1_FLAGS            (0x0)
#define STAI_GESTURE_STATE_1_ALIGNMENT        4
#define STAI_GESTURE_STATE_1_SIZE             (0)
#define STAI_GESTURE_STATE_1_SIZE_BYTES       (0)
/*****************************************************************************/
...
typedef struct {
  ...
  stai_ptr                     _activations[STAI_GESTURE_ACTIVATIONS_NUM];
  stai_ptr                     _weights[STAI_GESTURE_WEIGHTS_NUM];
  stai_ptr                     _inputs[STAI_GESTURE_IN_NUM];
  stai_ptr                     _outputs[STAI_GESTURE_OUT_NUM];
} _stai_gesture_context;
 ...
 *          @ref STAI_GESTURE_CONTEXT_SIZE or @ref stai_gesture_get_context_size(void) API
 ...
 *          on the input buffers whose memory adresses are retrived using @ref stai_gesture_get_inputs() API.
 *          Alternatively the application could allocate the inputs and set the addresses using the
 *          @ref stai_gesture_set_inputs() API. Similar behaviour is expected for the network outputs handling.
 *          The features of each input / output buffer (format, byte size, etc.)may be queried using
 *          @ref stai_gesture_get_info() API or the set of specific macros available in this header file.
 ...
 *          @ref stai_gesture_get_outputs() API.
 * @param[in] network network context opaque pointer
 ...
 */
STAI_API_ENTRY
stai_size stai_gesture_get_context_size(void);
 ...
 *          @ref stai_gesture_set_states() dual API
 * @param[in] network network context opaque pointer
 ...
 *          @ref stai_gesture_run() API. It is a helper routine that could be used by an application for debug
